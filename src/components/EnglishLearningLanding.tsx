...
export default function EnglishLearningLanding({ data }: EnglishLearningLandingProps) {
  ...
  // Đảm bảo các mảng luôn có giá trị mặc định để tránh lỗi khi build
  const {
    features = [],
    stats = [],
    testimonials = [],
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/ai-consultant" className="text-gray-700 hover:text-indigo-600 font-medium transition-colors">
                💬 Tư vấn AI
              </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/ai-consultant" className="border-2 border-white text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-white hover:text-indigo-600 transition-all duration-300 text-center">
                  💬 Tư vấn AI miễn phí
                </Link>
              </div>
            </div>
